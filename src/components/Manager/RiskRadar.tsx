...
const RiskRadar: React.FC = () => {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'high-stakes': return <AlertTriangle className="h-4 w-4" />;
      case 'rep-performance': return <TrendingDown className="h-4 w-4" />;
      case 'lead-source': return <Users className="h-4 w-4" />;

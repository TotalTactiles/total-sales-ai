      ...
      <CardContent className="pt-0">
        <div className="space-y-3">
          {actionItems.map((item) => (
            <div
              key={item.id}
              className={`p-4 rounded-lg border ${getPriorityColor(item.priority)} hover:shadow-md transition-all duration-200 cursor-pointer group`}
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <Button 
                  size="sm" 
                  className="bg-blue-600 hover:bg-blue-700 text-white text-xs px-3 py-1 h-7 group-hover:bg-blue-700 transition-colors"
                >
                  Take Action
        ...
        <div className="mt-4 pt-3 border-t border-gray-200">
          <Button 
            variant="outline" 
            className="w-full text-sm bg-blue-50 hover:bg-blue-100 border-blue-200 text-blue-700"
          >

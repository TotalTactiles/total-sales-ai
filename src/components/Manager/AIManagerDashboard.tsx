                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className={`font-semibold ${
                            member.stats.burnout_risk >= 70 ? 'text-red-600' : 
                            member.stats.burnout_risk >= 40 ? 'text-yellow-600' : 'text-green-600'
                          }`}>
                            {member.stats.burnout_risk >= 70 ? 'High' : 
                             member.stats.burnout_risk >= 40 ? 'Medium' : 'Low'}
                          </span>
                        </div>
                      </div>
                    </div>

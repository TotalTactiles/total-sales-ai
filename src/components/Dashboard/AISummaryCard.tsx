...
const AISummaryCard: React.FC<AISummaryCardProps> = ({ data, isFullUser }) => {
  const aiActions = [
    { icon: Mail, label: 'Emails Drafted', value: data.emailsDrafted, color: 'text-blue-600' },
    { icon: PhoneCall, label: 'Calls Scheduled', value: data.callsScheduled, color: 'text-green-600' },
    { icon: FileText, label: 'Proposals Generated', value: data.proposalsGenerated, color: 'text-purple-600' },
  ];

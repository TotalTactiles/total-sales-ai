...
const CompanyBrain = () => {
  ...
  return (
    <ProtectedRoute>
      <UsageTracker feature="company_brain" context="page_visit">
          ...
          <div className="container mx-auto p-4">
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full mt-6">
              <TabsList className="mb-4 grid grid-cols-5 w-full max-w-3xl">
                ...
                {isManager && <TabsTrigger value="ai-monitor">AI Monitor</TabsTrigger>}
              </TabsList>
              
              {/* Knowledge Base Tab */}
              <TabsContent value="knowledge-base">
                <UsageTracker feature="knowledge_base_tab" action="tab_open">
              ...
              <TabsContent value="case-studies">
                <UsageTracker feature="case_studies_tab" action="tab_open">
              ...
              <TabsContent value="objection-mapper">
                <UsageTracker feature="objection_mapper_tab" action="tab_open">
              ...
              <TabsContent value="brand-voice">
                <UsageTracker feature="brand_voice_tab" action="tab_open">
                  <BrandVoicePanel />
                </UsageTracker>
              </TabsContent>
              
              {/* AI Monitor Tab - Only for Managers */}
              {isManager && (
                <TabsContent value="ai-monitor">
                  <UsageTracker feature="ai_monitor_tab" action="tab_open">
                    <AIBrainMonitor />
                  </UsageTracker>
                </TabsContent>
              )}

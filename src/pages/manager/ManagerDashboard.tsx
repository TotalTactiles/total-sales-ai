...
import EnhancedBusinessOpsSnapshot from '@/components/Manager/EnhancedBusinessOpsSnapshot';
import { 
  Users, 
  Brain, 
  LineChart, 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
              <div className="lg:col-span-2 space-y-6">
                ...
                {/* Enhanced Business Operations Snapshot */}
                <EnhancedBusinessOpsSnapshot />
